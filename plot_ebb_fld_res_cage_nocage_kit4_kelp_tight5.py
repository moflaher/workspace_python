...
ax_fld.annotate(r'0.75 m s$^{-1}$',xy=(kl[0]+.035,kl[1]+.09),xycoords='axes fraction',zorder=30,fontsize=8)
aqk1=ax_fld.quiverkey(Q1,kl[0]+.075,kl[1]+.065,0.75, r'No drag', labelpos='E',fontproperties={'size': 8})
aqk2=ax_fld.quiverkey(Q2,kl[0]+.075,kl[1]+.03,0.75, r'Drag', labelpos='E',fontproperties={'size': 8})
aqk1.set_zorder(30)
aqk2.set_zorder(30)
...
ax_ebb.annotate(r'0.75 m s$^{-1}$',xy=(kl[0]+.035,kl[1]+.09),xycoords='axes fraction',zorder=30,fontsize=8)
aqk1=ax_ebb.quiverkey(Q1,kl[0]+.075,kl[1]+.065,0.75, r'No drag', labelpos='E',fontproperties={'size': 8})
aqk2=ax_ebb.quiverkey(Q2,kl[0]+.075,kl[1]+.03,0.75, r'Drag', labelpos='E',fontproperties={'size': 8})
aqk1.set_zorder(30)
aqk2.set_zorder(30)
...
ax_res.annotate(r'0.05 m s$^{-1}$',xy=(kl[0]+.035,kl[1]+.09),xycoords='axes fraction',zorder=30,fontsize=8)
aqk1=ax_res.quiverkey(Q1,kl[0]+.075,kl[1]+.065,0.05, r'No drag', labelpos='E',fontproperties={'size': 8})
aqk2=ax_res.quiverkey(Q2,kl[0]+.075,kl[1]+.03,0.05, r'Drag', labelpos='E',fontproperties={'size': 8})
aqk1.set_zorder(30)
aqk2.set_zorder(30)
...
ax_fld.text(.05,.925,"A",transform=ax_fld.transAxes,bbox={'facecolor':'white','edgecolor':'None', 'alpha':1, 'pad':3},zorder=31)
ax_ebb.text(.05,.925,"B",transform=ax_ebb.transAxes,bbox={'facecolor':'white','edgecolor':'None', 'alpha':1, 'pad':3},zorder=31)
ax_res.text(.05,.925,"C",transform=ax_res.transAxes,bbox={'facecolor':'white','edgecolor':'None', 'alpha':1, 'pad':3},zorder=31)
