...
cbarf=[.885,.1,.025,.8]
region1f=[.365,.55,.575,.39]
#region2f=[.36,.035,.575,.39]
region3f=[.535,.035,.275,.5]
...
tmp.set_zorder(40)
tmp=axsub1.annotate("",xy=(axsub3bb[0]+axsub3bb[2],axsub3bb[1]+axsub3bb[3]),xycoords='figure fraction',xytext=(region3['region'][1],region3['region'][3]), textcoords='data',arrowprops=dict(width=.5,shrink=0,color='g',headwidth=3))
tmp.set_zorder(40)
...
axes_label(axsub3,"C",drawn=True)
