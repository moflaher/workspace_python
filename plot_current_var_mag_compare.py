...
if cbfix==True:
    axtri1=ax0.tripcolor(data['trigrid'],cvarm_o,vmin=0,vmax=.8)
else:
...
if cbfix==True:
    axtri2=ax1.tripcolor(data['trigrid'],cvarm_diff_rel,vmin=-80,vmax=40)
else:
...
cb2.set_label(r'Relative difference current variance magnitude (%)',fontsize=8)
ax1.set_ylabel('')
