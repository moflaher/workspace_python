...
ax1.annotate("B",xy=(.975,.125),xycoords='axes fraction')
ax2.annotate("C",xy=(.975,.125),xycoords='axes fraction')
ax0.annotate("A",xy=(.975,.125),xycoords='axes fraction')

f.tight_layout(pad=0.2)
f.savefig(savepath +''+name+'_'+name2+'_'+regionname+'_18runs.png',dpi=150)
plt.close(f)
