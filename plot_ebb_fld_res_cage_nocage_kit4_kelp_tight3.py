...
ax_res.annotate(r'0.025 m s$^{-1}$',xy=(kl[0]+.035,kl[1]+.15),xycoords='axes fraction',zorder=30,fontsize=8)
aqk1=ax_res.quiverkey(Q1,kl[0]+.05,kl[1]+.1,0.025, r'No drag', labelpos='E',fontproperties={'size': 8})
aqk2=ax_res.quiverkey(Q2,kl[0]+.05,kl[1]+.0325,0.025, r'Drag', labelpos='E',fontproperties={'size': 8})
aqk1.set_zorder(30)
aqk2.set_zorder(30)
