...
for regionname in regionlist:
    ...
    axtri1=ax0.tripcolor(data['trigrid'],data1zeta,vmin=data1zeta[nidx].min(),vmax=data1zeta[nidx].max())
    diff=data1zeta-data2zeta
    axtri2=ax1.tripcolor(data['trigrid'],diff,vmin=diff[nidx].min(),vmax=diff[nidx].max())
    CS1=ax1.tricontour(data['trigrid'],diff,colors='w')
