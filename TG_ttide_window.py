...
savepath='{}/{}_{}/TG_ttide_window/{}_{}h/'.format(datapath,grid,datatype,name,window)
...
f.suptitle('Min: {}    Max: {}    Range: {}'.format(m2amp.min(),m2amp.max(),m2amp.max()-m2amp.min()))
...
f.suptitle('Min: {}    Max: {}    Range: {}'.format(m2phs.min(),m2phs.max(),m2phs.max()-m2phs.min()))
