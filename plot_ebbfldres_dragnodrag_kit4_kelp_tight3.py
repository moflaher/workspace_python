...
scale2=15
vectorspacing=50
fldax_r=[.125,.675,.825,.275]
ebbax_r=[.125,.375,.825,.275]
resax_r=[.125,.075,.825,.275]
ebbfldscale='0.25'
resscale='0.025'
ABC=[.025,.875]
...
aqk1=ax_fld.quiverkey(Q1,kl[0]+.05,kl[1]+.1,float(ebbfldscale), r'No drag', labelpos='E',fontproperties={'size': 8})
aqk2=ax_fld.quiverkey(Q2,kl[0]+.05,kl[1]+.0325,float(ebbfldscale), r'Drag', labelpos='E',fontproperties={'size': 8})
aqk1.set_zorder(30)
aqk2.set_zorder(30)
for label in ax_fld.get_yticklabels()[::2]:
    label.set_visible(False)
plotcoast(ax_fld,filename='pacific.nc',color='k')
ax_fld.text(-129.46,53.0665,'Campania Island',fontsize=6)
...
aqk2=ax_ebb.quiverkey(Q2,kl[0]+.05,kl[1]+.0325,float(ebbfldscale), r'Drag', labelpos='E',fontproperties={'size': 8})
aqk1.set_zorder(30)
aqk2.set_zorder(30)
for label in ax_ebb.get_yticklabels()[::2]:
    label.set_visible(False)
plotcoast(ax_ebb,filename='pacific.nc',color='k')
ax_ebb.text(-129.46,53.0665,'Campania Island',fontsize=6)
...
aqk1=ax_res.quiverkey(Q1,kl[0]+.05,kl[1]+.1,float(resscale), r'No drag', labelpos='E',fontproperties={'size': 8})
aqk2=ax_res.quiverkey(Q2,kl[0]+.05,kl[1]+.0325,float(resscale), r'Drag', labelpos='E',fontproperties={'size': 8})
aqk1.set_zorder(30)
aqk2.set_zorder(30)
...
ax_res.text(-129.46,53.0665,'Campania Island',fontsize=6)
