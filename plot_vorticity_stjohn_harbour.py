...
savepath='{}timeseries/{}_{}/vorticity_nemofvcom/{}_{}_{}_{:.3f}_{:.3f}/'.format(figpath,grid,datatype,name,region['regionname'],layer,cmin,cmax)
...
def plot_fun(i):
    ...
    dudy= data['a2u'][0,:]*data['u'][i,0,:]+data['a2u'][1,:]*data['u'][i,0,data['nbe'][:,0]]+data['a2u'][2,:]*data['u'][i,0,data['nbe'][:,1]]+data['a2u'][3,:]*data['u'][i,0,data['nbe'][:,2]]
    dvdx= data['a1u'][0,:]*data['v'][i,0,:]+data['a1u'][1,:]*data['v'][i,0,data['nbe'][:,0]]+data['a1u'][2,:]*data['v'][i,0,data['nbe'][:,1]]+data['a1u'][3,:]*data['v'][i,0,data['nbe'][:,2]]
    curl=dvdx-dudy
    ...
    cb.set_label(r'Vorticity',fontsize=10)    
    ...
    f.savefig(savepath + grid + '_' + region['regionname'] +'_vorticity_nemofvcom_' + ("%04d" %(i)) + '.png',dpi=300)
    plt.close(f)
