...
savepath='figures/png/' + grid + '_' + datatype + '/ttide_diff/' + name + '_' + regionname + '/'
...
ax1.set_title('No Cages')

ax2tri=ax2.tripcolor(data['trigrid'],el['tidecon'][:,3,0]-elold['tidecon'][:,3,0],vmin=(el['tidecon'][nidx,3,0]-elold['tidecon'][nidx,3,0]).min(),vmax=(el['tidecon'][nidx,3,0]-elold['tidecon'][nidx,3,0]).max())
ax2cb=plt.colorbar(ax2tri,ax=ax2)
ax2cb.set_label(r'Difference (m)')
ax2.yaxis.set_major_formatter(_formatter)
ax2.xaxis.set_major_formatter(_formatter)
ax2.set_ylabel(r'Latitude (N$^{\circ}$)')
ax2.set_title('Single Cage')

ax3tri=ax3.tripcolor(data['trigrid'],el['tidecon'][:,3,0]-elall['tidecon'][:,3,0],vmin=(el['tidecon'][nidx,3,0]-elall['tidecon'][nidx,3,0]).min(),vmax=(el['tidecon'][nidx,3,0]-elall['tidecon'][nidx,3,0]).max())
ax3cb=plt.colorbar(ax3tri,ax=ax3)
ax3cb.set_label(r'Difference (m)')
...
ax3.set_title('All Cages')

f.suptitle(r'M2 Elevation')
f.savefig(savepath + grid + '_' + regionname +'_el_m2_amp_difference.png',dpi=1200)
...
ax2tri=ax2.tripcolor(data['trigrid'],uv['tidecon'][:,3,0]-uvold['tidecon'][:,3,0],vmin=(uv['tidecon'][nidx,3,0]-uvold['tidecon'][nidx,3,0]).min(),vmax=(uv['tidecon'][nidx,3,0]-uvold['tidecon'][nidx,3,0]).max())
ax2cb=plt.colorbar(ax2tri,ax=ax2)
ax2cb.set_label(r'Difference (ms$^{-1}$)')
ax2.yaxis.set_major_formatter(_formatter)
ax2.xaxis.set_major_formatter(_formatter)
ax2.set_ylabel(r'Latitude (N$^{\circ}$)')
ax2.set_title('Single Cage')

ax3tri=ax3.tripcolor(data['trigrid'],uv['tidecon'][:,3,0]-uvall['tidecon'][:,3,0],vmin=(uv['tidecon'][nidx,3,0]-uvall['tidecon'][nidx,3,0]).min(),vmax=(uv['tidecon'][nidx,3,0]-uvall['tidecon'][nidx,3,0]).max())
ax3cb=plt.colorbar(ax3tri,ax=ax3)
ax3cb.set_label(r'Difference (ms$^{-1}$)')
ax3.yaxis.set_major_formatter(_formatter)
ax3.xaxis.set_major_formatter(_formatter)
ax3.axis(region['region'])
ax3.set_xlabel(r'Longitude (W$^{\circ}$)')
...
f.savefig(savepath + grid + '_' + regionname +'_uv_m2_amp_major_difference.png',dpi=1200)
