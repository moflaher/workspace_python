...
name='sjh_lr_v1_year_wd_gotm-my25_bathy20171109_dt30_calib1_jcool0_spring'
grid='sjh_lr_v1'
datatype='2d'
...
savepath='{}timeseries/{}_{}/salinity_nemofvcom/{}_{}_{}_{:.3f}_{:.3f}/'.format(figpath,grid,datatype,name,region['regionname'],layer,cmin,cmax)
...
def plot_fun(i):
    ...
    cb.set_label(r'Salinity (PSU)',fontsize=10)    
    ...
    f.savefig(savepath + grid + '_' + region['regionname'] +'_salinity_nemofvcom_' + ("%04d" %(i)) + '.png',dpi=300)
    plt.close(f)
