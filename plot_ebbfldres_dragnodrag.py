...
aqk1=ax_fld.quiverkey(Q1,kl[0]+arrowshift1,kl[1]+.065,float(ebbfldscale), r'No drag', labelpos='W',fontproperties={'size': 8})
aqk2=ax_fld.quiverkey(Q2,kl[0]+arrowshift1,kl[1]+.03,float(ebbfldscale), r'Drag', labelpos='W',fontproperties={'size': 8})
aqk1.set_zorder(30)
aqk2.set_zorder(30)
...
aqk1=ax_ebb.quiverkey(Q1,kl[0]+arrowshift1,kl[1]+.065,float(ebbfldscale), r'No drag', labelpos='W',fontproperties={'size': 8})
aqk2=ax_ebb.quiverkey(Q2,kl[0]+arrowshift1,kl[1]+.03,float(ebbfldscale), r'Drag', labelpos='W',fontproperties={'size': 8})
aqk1.set_zorder(30)
aqk2.set_zorder(30)
...
aqk1=ax_res.quiverkey(Q1,kl[0]+arrowshift1,kl[1]+.065,float(resscale), r'No drag', labelpos='W',fontproperties={'size': 8})
aqk2=ax_res.quiverkey(Q2,kl[0]+arrowshift1,kl[1]+.03,float(resscale), r'Drag', labelpos='W',fontproperties={'size': 8})
aqk1.set_zorder(30)
aqk2.set_zorder(30)
